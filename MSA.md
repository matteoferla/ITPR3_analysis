...
Hindsight note:
Unfortunately, I only checked in Uniprot and did not do a blast search in NCBI.
Sea lamprey (which predates the fish tetraduplication, thus making it very valuable),
has no ITPR homologue in Uniprot, but  
has a protein of low confidence in NCBI https://www.ncbi.nlm.nih.gov/protein/XP_032819189.1
